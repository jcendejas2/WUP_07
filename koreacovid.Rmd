...
The p-value from the fisher's test was 0.0009 and the chisquare was 0.0012 which are < 0.05 therefore we reject the null hypothesis. The graphs shows that there is a significant difference between percent of males dying and the percentage of females dying.   
